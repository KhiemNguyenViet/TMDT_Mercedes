 <?php
    class class_check extends class_manage
    {
        ...
        function rate($diem)
        {
            ...
            for ($i = 1; $i <= 10; $i++) {
                if ($i == 1) {
                    $title = 'Không còn gì để nói...';
                } else if ($i == 2) {
                    $title = 'Thật không thể tin nổi.';
                } else if ($i == 3) {
                    $title = 'Cái gì thế này ?!';
                } else if ($i == 4) {
                    $title = 'Haizz';
                } else if ($i == 5) {
                    $title = 'Tạm';
                ...
                if ($i <= $diem) {
                    $list .= '<img alt="' . $i . '" id="rate_' . $i . '" src="/images/star-on.png" title="' . $title . '"> ';
                } else {
                    $list .= '<img alt="' . $i . '" id="rate_' . $i . '" src="/images/star-off.png" title="' . $title . '"> ';
                }
            }
        ...
        /////////////////////////////////
        function show_smile($id, $size, $directory = './images/smile/default/')
        {
            if ($directory != '.') {
        ...
        /////////////////////////////////
        function show_smile_chat($size, $directory = './images/smile/default/')
        {
            if ($directory != '.') {
                $directory = rtrim($directory, '/') . '/';
            }
